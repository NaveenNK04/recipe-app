        ...
        <div className="bg-[#faf9fb] p-10 flex-1">
            <div className="max-w-screen-lg mx-auto">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li><strong>Authentic Tamil Recipes:</strong> Explore a curated collection of traditional Tamil recipes, each crafted to deliver an authentic taste of our culture. From comforting classics to modern twists, we have something for every palate.</li>
                ...
                <p className="text-lg mb-4">
                    At Semmaiya Samaikkurom Bayangarama Rusikurom, we believe in the power of food to bring people together. Our commitment to quality, authenticity, and user experience sets us apart. We strive to provide a platform that inspires creativity and fosters a love for cooking in every home.
                </p>

                <h2 className="text-2xl font-bold mb-2">Join Us on This Culinary Journey</h2>
                <p className="text-lg mb-4">
                    We invite you to explore our recipe finder, discover delightful dishes, and embark on a culinary adventure with us. Thank you for being a part of Semmaiya Samaikkurom Bayangarama Rusikurom! Let’s cook up something delicious together!
                </p>
